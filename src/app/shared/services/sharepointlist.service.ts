...
export class SharepointlistService implements OnInit{
  ...
  public webAbsoluteUrl = "https://portaldv.bergerbd.com/leaveauto"; //uncomment for localhost //PendingApproval
  ...
  //=============== only this generic method is being used for Dashboard to fetch data =========
  public fetchListItemsWith3NdFilterExpand(list?: any, user?: any):Promise<any>{
    let userADId = user;
  ...
  public fetchListItemWithExpStFilOrd(list?: any, user?: any):  Promise<any>{
    let userADId = user;    
